...
3. 중심점이 건물 내부 또는 경계에 걸쳐 있으면 그 건물은 건너뛰고 heading 방향의 다음 건물을 찾을 것
4. 건물명이 여러 개면 heading 방향에서 가장 가까운 하나만
5. 건물명을 찾을 수 없으면 buildingName을 null로 하되, 해당 방향에 보이는 상호명(가게/은행/식당 등)이나 아파트 동 번호(예: 104동, B동)를 clue에 넣을 것
6. 아무것도 없으면 둘 다 null
